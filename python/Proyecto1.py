...
imagen_original = Image.open('imagen.jpeg')
img1 = cv2.imread('imagen.jpeg')
...
imagen_procesada.save('laplace-imagen.jpeg')
img2 = cv2.imread('laplace-imagen.jpeg') 
...
cv2.imwrite('imagen-mejorada.jpeg', resImg)
